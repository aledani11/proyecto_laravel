...
@section('title','Servicios turismo')
...
@section('header', 'Servicios turismo')
...
<div class="container" style="margin-top:30px">
    <div class="row">
        ...
        <div class="col-md-2 form-group mt-5">
            <div class="col-md-12">
                <a class="btn btn-dark form-group" href="{{ route('servicios_turismo.create') }}">Agregar</a>
            </div>
            <div class="col-md-12">
                <a id="anular" class="btn btn-dark form-group" onclick="return mensaje_anular()" href="{{ route('servicios_turismo.destroy', 'empty') }}">Anular</a>
            </div>
            <div class="col-md-12">
                <a id="modificar" style="display: none;" class="btn btn-dark form-group" onclick="return mensaje_modificar()" href="{{ route('servicios_turismo.edit', 'empty') }}">Modificar</a>
            </div>
        </div>
    </div>
</div>
