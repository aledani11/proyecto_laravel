...
<form onsubmit="return validateForm()" method="POST" action="{{route('user_numero.store')}}">
    @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select id="numero" name="caja" required>
                        ...
                        @foreach($caja as $caj)
                        <option value={{ $caj->id }}>{{ $caj->numero }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" id="user" name="user" class="readonly" required autocomplete="off" style="caret-color: transparent !important;">
                    <input type="button" value="..." class=" btn-dark" onclick="openWin('user')">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-10">
                <div class="d-flex flex-wrap justify-content-md-around ">
                    ...
                    <div class="p-2 mx-auto"><button type="button" onclick="location.href = '{{ route('user_numero.index') }}'" class="btn btn-dark">SALIR</button></div>
                </div>
            </div>
        </div>
    </div>
