...
<div class="container" style="margin-top:30px">
    <div class="row">
        ...
        <div class="col-md-2 form-group mt-5">
            ...
            <div class="col-md-12">
                <a id="modificar" style="display: none;" class="btn btn-dark form-group" onclick="return mensaje_modificar()" href="{{ route('arqueo.edit', 'empty') }}">Modificar</a>
            </div>
        </div>
    </div>
</div>
