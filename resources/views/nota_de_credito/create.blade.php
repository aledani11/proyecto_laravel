...
@section('title','Nota de credito agregar')
...
@section('header', 'Nota de credito agregar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('nota_de_credito.store')}}">
    @csrf
        ...
        <div class="row">
            <div class="col-md-10">
                <div class="d-flex flex-wrap justify-content-md-around ">
                    ...
                    <div class="p-2 mx-auto"><button type="button" onclick="location.href = '{{ route('nota_de_credito.index') }}'" class="btn btn-dark">SALIR</button></div>
                </div>
            </div>
        </div>
    </div>
