...
@section('title','Timbrado agregar')
...
@section('header', 'Timbrado agregar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('timbrado.store')}}">
    @csrf
<br>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" id="numero1" name="numero1" readonly>
                </div>
                <div class="form-group">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="d-flex flex-wrap justify-content-md-around ">
                    ...
                    <div class="p-2 mx-auto"><button type="button" onclick="location.href = '{{ route('timbrado.index') }}'" class="btn btn-dark">SALIR</button></div>
                </div>
            </div>
        </div>
    </div>
