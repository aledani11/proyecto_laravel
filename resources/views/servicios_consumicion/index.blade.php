...
@section('title','Servicios consumicion')
...
@section('header', 'Servicios consumicion')
...
<div class="container" style="margin-top:30px">
    <div class="row">
        ...
        <div class="col-md-2 form-group mt-5">
            <div class="col-md-12">
                <a class="btn btn-dark form-group" href="{{ route('servicios_consumicion.create') }}">Agregar</a>
            </div>
            <div class="col-md-12">
                <a id="anular" class="btn btn-dark form-group" onclick="return mensaje_anular()" href="{{ route('servicios_consumicion.destroy', 'empty') }}">Anular</a>
            </div>
            <div class="col-md-12">
