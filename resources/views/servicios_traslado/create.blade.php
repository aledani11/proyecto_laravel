...
@section('title','Servicios traslado agregar')
...
@section('header', 'Servicios traslado agregar')

@section('content')

<form onsubmit="return validateForm()" method="POST" action="{{route('servicios_traslado.store')}}">
    @csrf
        ...
        <div class="row">
            <div class="col-md-10">
                <div class="d-flex flex-wrap justify-content-md-around ">
                    ...
                    <div class="p-2 mx-auto"><button type="button" onclick="location.href = '{{ route('servicios_traslado.index') }}'" class="btn btn-dark">SALIR</button></div>
                </div>
            </div>
        </div>
    </div>
